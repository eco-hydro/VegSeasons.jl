...
@testset "Prominence" begin
  ...
  x = range(0.0, stop=1.0, length=1000) |> collect
  ...
  peaks = findpeaks(data, x, min_prom=4.0)
...
@testset "Threshold" begin
  y = [0.0, 1.0, 3.0, 1.0, 4.0, 5.0, 3.0, 0.0, 2.0, 5.0, 4.0, 0.0]
...
@testset "Min. Height" begin
  ...
  @test Set(findpeaks(y, min_height=6.0)) == Set([])
